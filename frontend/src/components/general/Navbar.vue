<template>
  ...
  >
    ...
    >
      <!-- Logo for Desktop - Positioned Absolutely on the Left -->
      <div
      ...
      <!-- Main Navigation Links - Centered in Available Space -->
...
const checkDeviceSize = (): void => {
  ...
  isMobileOrTablet.value = width < 768; // below md breakpoint in Tailwind
};
