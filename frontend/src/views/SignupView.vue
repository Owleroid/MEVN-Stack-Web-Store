    ...
    <div class="signup">
      ...
      <form @submit.prevent="handleSignup">
        <div class="form-group">
          ...
          <input v-model="email" type="email" id="email" :placeholder="$t('signupView.email')" required />
        </div>
        <div class="form-group">
          <label for="password">{{ $t('signupView.password') }}</label>
          <input v-model="password" type="password" id="password" :placeholder="$t('signupView.password')" required />
        </div>
